		var thinker = new function(){
			...
			var mainWorkerMsgInThinker = function(event) {
				...
				switch (event.data.resCommand) {
					...
					case 'singleThreadAiSolved':
					
						var callback = getCallback(event.data.resData.callbackId)
									
						callback(event.data.resData.move);
					
						//TODO: make this general callback function
			...
			thinker.singleThreadAi = function (game, desiredDepth, callback) {
